...
func registerAPIRoutes(a *echo.Group) {
	...
	// ArchTask Addition - Register ArchTask AI endpoints under JWT-authenticated group.
	// All endpoints require a valid JWT token (enforced by SetupTokenMiddleware above).
	ValidateArchTaskConfig()
	archTaskGroup := a.Group("/archtask")
	RegisterAIRoutes(archTaskGroup)
}
