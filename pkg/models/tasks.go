...
type Task struct {
	...
	// ArchTask Addition - Architectural phase classification and AI generation flag.
	// arch_phase values: SD, DD, CD, CA, Academic, or empty string for unclassified tasks.
	ArchPhase   string `xorm:"varchar(20) null" json:"arch_phase"`
	AIGenerated bool   `xorm:"not null default false" json:"ai_generated"`
...
type taskSearchOptions struct {
	...
	projectViewID      int64
	// ArchTask Addition - Filter tasks by architectural phase (SD, DD, CD, CA, Academic).
	archPhase          string
}
